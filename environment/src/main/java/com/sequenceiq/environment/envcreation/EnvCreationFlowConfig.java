...
import static com.sequenceiq.environment.envcreation.EnvCreationEvent.ENV_CREATION_FAILURE_HANDLED_EVENT;
import static com.sequenceiq.environment.envcreation.EnvCreationEvent.FINISH_ENV_CREATION_EVENT;
import static com.sequenceiq.environment.envcreation.EnvCreationEvent.START_ENV_CREATION_EVENT;
import static com.sequenceiq.environment.envcreation.EnvCreationEvent.FINALIZE_ENV_CREATION_EVENT;
import static com.sequenceiq.environment.envcreation.EnvCreationState.ENV_CREATION_FAILED_STATE;
import static com.sequenceiq.environment.envcreation.EnvCreationState.ENV_CREATION_FINISHED_STATE;
import static com.sequenceiq.environment.envcreation.EnvCreationState.ENV_CREATION_STARTED_STATE;
import static com.sequenceiq.environment.envcreation.EnvCreationState.FINAL_STATE;
import static com.sequenceiq.environment.envcreation.EnvCreationState.INIT_STATE;
