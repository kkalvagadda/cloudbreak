...
class OpenStackCredentialV1ParametersToOpenStackCredentialAttributesConverter {
    ...
    public OpenStackCredentialAttributes convert(OpenstackParameters source) {
        ...
        NullUtil.ifNotNull(source.getKeystoneV2(), param -> response.setKeystoneV2(getKeystoneV2(param)));
        NullUtil.ifNotNull(source.getKeystoneV3(), param -> response.setKeystoneV3(getKeystoneV3(param)));
