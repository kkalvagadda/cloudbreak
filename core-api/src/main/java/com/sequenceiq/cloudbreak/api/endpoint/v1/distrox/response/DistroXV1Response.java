...
import com.sequenceiq.cloudbreak.api.endpoint.v1.distrox.response.environment.placement.PlacementSettingsV1Response;
...
public class DistroXV1Response extends StackV4Base {
    ...
    public StackImageV1Response getImage() {
        return image;
    }

    public void setImage(StackImageV1Response image) {
        this.image = image;
    }
